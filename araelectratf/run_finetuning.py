...
from araelectratf.finetune import preprocessing, task_builder
from araelectratf.model import modeling, optimization
from araelectratf.util import training_utils, utils
...
def run_finetuning(config: configure_finetuning.FinetuningConfig):
    ...
    for task in tasks:
        return model_runner.evaluate_task(task, "dev", True)
...
def run_evaluation(model):
    ...
    return run_finetuning(configure_finetuning.FinetuningConfig(
        "tf-araelectra", model, **hparams))
